...
<body>
	...
	<h2 style="color: pink; font-size: 40px;" align="center">pipeline project</h2>
	<h2 style="color: pink; font-size: 40px;" align="center">webhook integrated, use jenins url and add last /github/webhook/</h2>
