...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center"> nexus completed/cd</h1>
	<h1 style="color: blue; font-size: 40px;" align="center"> nexus completed and practiced/cd</h1>
